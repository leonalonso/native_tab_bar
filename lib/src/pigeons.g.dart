  ...
  static void setup(NativeTabBarFlutterApi? api, {BinaryMessenger? binaryMessenger}) {
    {
      ...
      if (api == null) {
        ...
        channel.setMessageHandler((Object? message) async {
          ...
          assert(arg_id != null, 'Argument for dev.flutter.pigeon.NativeTabBarFlutterApi.wantsHeight was null, expected non-null String.');
          final double? arg_height = (args[1] as double?);
          assert(arg_height != null, 'Argument for dev.flutter.pigeon.NativeTabBarFlutterApi.wantsHeight was null, expected non-null double.');
    ...
    }
    {
      ...
      if (api == null) {
        ...
        channel.setMessageHandler((Object? message) async {
          ...
          final List<Object?> args = (message as List<Object?>?)!;
          final String? arg_id = (args[0] as String?);
          assert(arg_id != null, 'Argument for dev.flutter.pigeon.NativeTabBarFlutterApi.valueChanged was null, expected non-null String.');
          final int? arg_selectedIndex = (args[1] as int?);
          assert(arg_selectedIndex != null, 'Argument for dev.flutter.pigeon.NativeTabBarFlutterApi.valueChanged was null, expected non-null int.');
    ...
    }
    {
      ...
      if (api == null) {
        ...
        channel.setMessageHandler((Object? message) async {
          ...
          final List<Object?> args = (message as List<Object?>?)!;
          final String? arg_id = (args[0] as String?);
          assert(arg_id != null, 'Argument for dev.flutter.pigeon.NativeTabBarFlutterApi.refresh was null, expected non-null String.');
          api.refresh(arg_id!);
          return;
        });
      }
