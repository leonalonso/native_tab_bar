...
class NativeTabIconData {
  ...
  static NativeTabIconData decode(Object result) {
    ...
    return NativeTabIconData(
      ...
      fontPackage: result[2] as String?,
      selectedCodePoint: result[3] as int?,
      selectedFontFamily: result[4] as String?,
      selectedFontPackage: result[5] as String?,
    );
  }
}
